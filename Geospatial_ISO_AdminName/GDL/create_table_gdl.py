...
ALTER TABLE geospatial_data_gdl
ADD CONSTRAINT unique_gdl_entry UNIQUE (gid, admin_level, date, variable);
"""
...
def create_gdl_table():
    """
    Create the GDL data table in the local PostgreSQL database using the predefined SQL.
    ...
    try:
        ...
        print("GDL data table created successfully with unique constraint.")

    except (Exception, psycopg2.Error) as error:
        print(f"Error creating GDL data table or adding constraint: {error}")
