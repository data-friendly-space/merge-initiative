...
ALTER TABLE geospatial_data_nvdi
ADD CONSTRAINT unique_nvdi_entry UNIQUE (gid, admin_level, date, variable);
"""
...
def create_nvdi_table():
    """
    Create the NVDI data table in the local PostgreSQL database using the predefined SQL.
    ...
    try:
        ...
        print("NVDI data table created successfully with unique constraint.")

    except (Exception, psycopg2.Error) as error:
        print(f"Error creating NVDI data table or adding constraint: {error}")
