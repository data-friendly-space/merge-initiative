...
CREATE TABLE IF NOT EXISTS geospatial_data_merra2 (
...
ALTER TABLE geospatial_data_merra2
ADD CONSTRAINT unique_merra2_entry UNIQUE (gid, admin_level, date, variable);
"""
...
def create_merra2_table():
    """
    Create the MERRA2 data table in the local PostgreSQL database using the predefined SQL.
    ...
    try:
        ...
        print("MERRA2 data table created successfully with unique constraint.")

    except (Exception, psycopg2.Error) as error:
        print(
            f"Error creating MERRA2 data table or adding constraint: {error}"
        )
